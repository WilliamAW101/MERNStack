  ...
  void _showLocationDialog(BuildContext context, Color textColor, bool isDark) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: isDark ? const Color.fromARGB(255, 0, 0, 0) : null, // Dark theme background color
        title: const Text('Add Location', style: TextStyle(color: Color.fromARGB(255, 255, 255, 255))),
        content: TextField(
